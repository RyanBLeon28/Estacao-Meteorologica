...
//<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
  ...
  //2*3,14*0.075 = 0.471238898
  Serial.print((average*0.471238898)/60);
  Serial.println(" m/s");
  ...
  int vel = ((average*0.471238898)/60);
  dtostrf(vel, 6, 2, string);  // (<variable>,<amount of digits we are going to use>,<amount of decimal digits>,<string name>)
